...
const button__previous_view = document.getElementById(
  "button__previous_view"
) as HTMLButtonElement;
const button__next_view = document.getElementById(
  "button__next_view"
) as HTMLButtonElement;
const button__search = document.getElementById(
  "button__search"
) as HTMLButtonElement;
const button__previous_pokemon = document.getElementById(
  "button__previous_pokemon"
) as HTMLInputElement;
const button__next_pokemon = document.getElementById(
  "button__next_pokemon"
) as HTMLInputElement;
